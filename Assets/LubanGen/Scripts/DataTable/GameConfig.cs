...
public sealed partial class GameConfig :  Bright.Config.BeanBase, System.ICloneable 
{
    ...
    public GameConfig(bool is_david_dead, bool is_rebellion_start, int current_day, int current_stage, bool wear_tie ) 
    {
    ...
    public object Clone()
    {
        return new GameConfig(this.IsDavidDead, this.IsRebellionStart, this.CurrentDay, this.CurrentStage, this.WearTie);
    }
