...
namespace GameKit
{
    public static partial class Utility
    {
        public static class Debugger
        {
            ...
            public static void LogWarning(string info) => Debug.Log(GameKit.Utility.Text.Format("<b><color=orange>[Warning]</color></b> {0}", info));
            public static void LogError(string info) => Debug.LogError(GameKit.Utility.Text.Format("<b><color=red>[Error]</color></b> {0}", info));
            public static void LogSuccess(string info) => Debug.Log(GameKit.Utility.Text.Format("<b><color=green>[Success]</color></b> {0}", info));
            public static void LogFail(string info) => Debug.Log(GameKit.Utility.Text.Format("<b><color=red>[Failed]</color></b> {0}", info));
