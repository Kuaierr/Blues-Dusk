...
namespace GameKit.Utilities
{
    public static class Utilities
    {
        ...
        private static Animator tempAnimator;
        private static UnityAction tempUnityAction;
        ...
        {
            AnimatorStateInfo info = tempAnimator.GetCurrentAnimatorStateInfo(0);
            // Debug.Log(info.normalizedTime);
            if (info.normalizedTime >= tempTime)
            {
                tempUnityAction?.Invoke();
