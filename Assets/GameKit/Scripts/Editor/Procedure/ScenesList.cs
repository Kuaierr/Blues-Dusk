...
public static class ScenesList
{
    ...
    public static void Assets_Tutorials_Attributes_Attributes_unity() { ScenesUpdate.OpenScene("Assets/Tutorials/Attributes/Attributes.unity"); }
    [MenuItem("Scenes/MyDotween")]
    public static void Assets_Tutorials_MyDotween_MyDotween_unity() { ScenesUpdate.OpenScene("Assets/Tutorials/MyDotween/MyDotween.unity"); }
}
#endif
