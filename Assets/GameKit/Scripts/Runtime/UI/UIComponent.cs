...
namespace UnityGameKit.Runtime
{
    ...
    public sealed partial class UIComponent : GameKitComponent
    {
        ...
        protected override void Awake()
        {
            ...
            if (m_UIManager == null)
            {
                Utility.Debugger.LogFail("UI manager is invalid.");
                return;
            }
        ...
        private void Start()
        {
            ...
            {
                Utility.Debugger.LogFail("Base component is invalid.");
                return;
            }
            ...
            {
                Utility.Debugger.LogError("Can not create UI form helper.");
                return;
            }
            ...
            for (int i = 0; i < m_UIGroups.Length; i++)
            {
                ...
                {
                    Utility.Debugger.LogWarning("Add UI group '{0}' failure.", m_UIGroups[i].Name);
                    continue;
                }
            }
        }
        ...
        public bool AddUIGroup(string uiGroupName, int depth)
        {
            ...
            {
                Utility.Debugger.LogError("Can not create UI group helper.");
                return false;
            }
            ...
            return m_UIManager.AddUIGroup(uiGroupName, uiGroupHelper, depth);
        }
        ...
        public void GetUIForms(string uiFormAssetName, List<UIForm> results)
        {
            if (results == null)
            {
                Utility.Debugger.LogError("Results is invalid.");
                return;
            }
        ...
        public void SetUIFormInstanceLocked(UIForm uiForm, bool locked)
        {
            if (uiForm == null)
            {
                Utility.Debugger.LogWarning("UI form is invalid.");
                return;
            }
