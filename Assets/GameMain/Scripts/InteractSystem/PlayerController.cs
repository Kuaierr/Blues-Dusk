...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField]
    private float SmoothingLength = 0.25f;  //handler 影响曲率
    [SerializeField]
    private int SmoothingSections = 10;  //points in each section 每两个waypoint之间生成的点数
    [SerializeField]
    [Range(-1, 1)]
    private float SmoothingFactor = 0;  //移动的最大夹角
    ...
    [SerializeField]
    [Range(0, 0.99f)]
    private float Smoothing = 0.25f; //平滑系数
    [SerializeField]
    private float RotateSpeed = 1; //旋转速度系数
    [SerializeField]
